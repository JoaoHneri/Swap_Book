...
import '../BooksDetails/BooksDetails.css';
    ...
    <>
      ...
      {searchProducts ? (
        ...
        <div className="book-details-container">
          <div className="flex flex-col items-center justify-center min-h-screen bg-gray-200 my-1">
            <div className="max-w-6xl bg-white p-5 rounded-lg mt-50 edit-mgt shadow-lg">
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="sm:w-2/3 sm:pl-6 mt-4 sm:mt-0">
                  <h1 className="text-3xl font-bold title-edit-details mb-4">
                    {response.name}
                  </h1>
                  <span className="text-gray-600 text-sm mb-2">
                    Autor(a): {response.author}
                  </span>
                  <p className="text-gray-800 text-lg tx-sin font-medium mb-4">
                    <span id="edit-sin-tx">Sinopse:</span>
                    <br /> {response.synopsis}
                  </p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-2xl font-bold">
                      <h6>
                        Postado por:{' '}
                        <Link to={`/user_presentation/${response.user}`}>
                          {userPost.name}
                        </Link>{' '}
                      </h6>
                    </div>
